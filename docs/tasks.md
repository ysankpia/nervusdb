...
| T59 | v2 Label Interning（标签字符串 ↔ u32 映射） | L3 | P1 | WIP | feat/T59-v2-label-interning | 实现 String↔LabelId 映射；自动标签创建与查找；`GraphEngine::get_or_create_label()`；支持 `MATCH (n:User)` 语法；设计文档见 `docs/design/T59-v2-label-interning.md` |
