...
// CID_REGISTRY_START
// CID-SHARED-001 | mode=success | case=t01_create_single_node
// CID-SHARED-002 | mode=success | case=t01_match_return_node
// CID-SHARED-003 | mode=success | case=t01_create_relationship
// CID-SHARED-004 | mode=success | case=t01_set_property
// CID-SHARED-005 | mode=success | case=t01_set_overwrite
// CID-SHARED-006 | mode=success | case=t01_remove_property
// CID-SHARED-007 | mode=success | case=t01_delete_node_detach
// CID-SHARED-008 | mode=success | case=t01_delete_rel_only
// CID-SHARED-009 | mode=success | case=t01_multi_create
// CID-SHARED-010 | mode=success | case=t01b_return_scalar
// CID-SHARED-011 | mode=success | case=t01b_return_alias
// CID-SHARED-012 | mode=success | case=t01b_return_distinct
// CID-SHARED-013 | mode=success | case=t01b_return_star
// CID-SHARED-014 | mode=success | case=t02_multi_label_create
// CID-SHARED-015 | mode=success | case=t02_single_label_subset
// CID-SHARED-016 | mode=success | case=t03_null_property
// CID-SHARED-017 | mode=success | case=t03_bool_properties
// CID-SHARED-018 | mode=success | case=t03_integer_property
// CID-SHARED-019 | mode=success | case=t03_negative_integer
// CID-SHARED-020 | mode=success | case=t03_float_property
// CID-SHARED-021 | mode=success | case=t03_string_special_chars
// CID-SHARED-022 | mode=success | case=t03_list_literal
// CID-SHARED-023 | mode=success | case=t03_map_literal
// CID-SHARED-024 | mode=success | case=t03_list_property
// CID-SHARED-025 | mode=success | case=t04_where_equality
// CID-SHARED-026 | mode=success | case=t04_where_gt
// CID-SHARED-027 | mode=success | case=t04_where_and
// CID-SHARED-028 | mode=success | case=t04_where_or
// CID-SHARED-029 | mode=success | case=t04_where_not
// CID-SHARED-030 | mode=success | case=t04_where_in
// CID-SHARED-031 | mode=success | case=t04_where_starts_with
// CID-SHARED-032 | mode=success | case=t04_where_contains
// CID-SHARED-033 | mode=success | case=t04_where_ends_with
// CID-SHARED-034 | mode=success | case=t04_where_is_null
// CID-SHARED-035 | mode=success | case=t04_where_is_not_null
// CID-SHARED-036 | mode=success | case=t05_order_by_asc
// CID-SHARED-037 | mode=success | case=t05_order_by_desc
// CID-SHARED-038 | mode=success | case=t05_limit
// CID-SHARED-039 | mode=success | case=t05_skip
// CID-SHARED-040 | mode=success | case=t05_with_pipe
// CID-SHARED-041 | mode=success | case=t05_unwind
// CID-SHARED-042 | mode=success | case=t05_unwind_create
// CID-SHARED-043 | mode=success | case=t05_union
// CID-SHARED-044 | mode=success | case=t05_union_all
// CID-SHARED-045 | mode=success | case=t05_optional_match
// CID-SHARED-046 | mode=success | case=t06_count
// CID-SHARED-047 | mode=success | case=t06_sum
// CID-SHARED-048 | mode=success | case=t06_avg
// CID-SHARED-049 | mode=success | case=t06_min_max
// CID-SHARED-050 | mode=success | case=t06_collect
// CID-SHARED-051 | mode=success | case=t06_count_distinct
// CID-SHARED-052 | mode=success | case=t06_group_by
// CID-SHARED-053 | mode=success | case=t07_merge_create
// CID-SHARED-054 | mode=success | case=t07_merge_match_existing
// CID-SHARED-055 | mode=success | case=t07_merge_on_create_set
// CID-SHARED-056 | mode=success | case=t07_merge_on_match_set
// CID-SHARED-057 | mode=success | case=t07_merge_relationship
// CID-SHARED-058 | mode=success | case=t08_case_simple
// CID-SHARED-059 | mode=success | case=t08_case_generic
// CID-SHARED-060 | mode=success | case=t09_tostring
// CID-SHARED-061 | mode=success | case=t09_toupper
// CID-SHARED-062 | mode=success | case=t09_tolower
// CID-SHARED-063 | mode=success | case=t09_trim
// CID-SHARED-064 | mode=success | case=t09_size
// CID-SHARED-065 | mode=success | case=t09_left
// CID-SHARED-066 | mode=success | case=t09_right
// CID-SHARED-067 | mode=success | case=t10_arithmetic
// CID-SHARED-068 | mode=success | case=t10_modulo
// CID-SHARED-069 | mode=success | case=t10_abs
// CID-SHARED-070 | mode=success | case=t10_tointeger
// CID-SHARED-071 | mode=success | case=t11_variable_length_path
// CID-SHARED-072 | mode=success | case=t11_variable_length_exact
// CID-SHARED-073 | mode=success | case=t11_path_return
// CID-SHARED-074 | mode=success | case=t11_shortest_path
// CID-SHARED-075 | mode=success | case=t12_exists_subquery
// CID-SHARED-076 | mode=success | case=t13_foreach
// CID-SHARED-077 | mode=success | case=t14_write_txn_commit
// CID-SHARED-078 | mode=success | case=t14_write_txn_rollback_via_drop
// CID-SHARED-079 | mode=error | case=t14_multiple_writes_in_txn
// CID-SHARED-080 | mode=success | case=t14_commit_consumes_self
// CID-SHARED-081 | mode=error | case=t15_syntax_error
// CID-SHARED-082 | mode=error | case=t15_unknown_function
// CID-SHARED-083 | mode=error | case=t15_query_error_type
// CID-SHARED-084 | mode=error | case=t15_nervusdb_error_io
// CID-SHARED-085 | mode=error | case=t15_nervusdb_error_storage
// CID-SHARED-086 | mode=error | case=t15_nervusdb_error_query
// CID-SHARED-087 | mode=success | case=t16_outgoing
// CID-SHARED-088 | mode=success | case=t16_incoming
// CID-SHARED-089 | mode=success | case=t16_undirected
// CID-SHARED-090 | mode=success | case=t16_multi_rel_types
// CID-SHARED-091 | mode=success | case=t17_triangle
// CID-SHARED-092 | mode=success | case=t17_multi_hop
// CID-SHARED-093 | mode=success | case=t17_fan_out
// CID-SHARED-094 | mode=success | case=t18_bulk_100
// CID-SHARED-095 | mode=success | case=t18_bulk_1000
// CID-SHARED-096 | mode=success | case=t18_bulk_unwind
// CID-SHARED-097 | mode=success | case=t19_persistence
// CID-SHARED-098 | mode=success | case=t20_empty_match
// CID-SHARED-099 | mode=success | case=t20_count_empty
// CID-SHARED-100 | mode=success | case=t20_return_null
// CID-SHARED-101 | mode=success | case=t20_large_string
// CID-SHARED-102 | mode=success | case=t20_self_loop
// CID-SHARED-103 | mode=success | case=t20_duplicate_property_overwrite
// CID-SHARED-104 | mode=success | case=t36_unwind_with_index
// CID-SHARED-105 | mode=success | case=t36_unwind_empty_list
// CID-SHARED-106 | mode=success | case=t36_unwind_with_aggregation
// CID-SHARED-107 | mode=success | case=t36_unwind_create_nodes
// CID-SHARED-108 | mode=success | case=t36_unwind_range
// CID-SHARED-109 | mode=success | case=t37_union_dedup
// CID-SHARED-110 | mode=success | case=t37_union_all_keeps_dupes
// CID-SHARED-111 | mode=success | case=t37_union_multi
// CID-SHARED-112 | mode=success | case=t37_union_with_match
// CID-SHARED-113 | mode=success | case=t38_with_multi_stage
// CID-SHARED-114 | mode=success | case=t38_with_distinct
// CID-SHARED-115 | mode=success | case=t38_with_aggregation
// CID-SHARED-116 | mode=success | case=t39_pagination_page1
// CID-SHARED-117 | mode=success | case=t39_pagination_page2
// CID-SHARED-118 | mode=success | case=t39_order_by_multi_column
// CID-SHARED-119 | mode=success | case=t39_skip_beyond_results
// CID-SHARED-120 | mode=success | case=t40_coalesce
// CID-SHARED-121 | mode=success | case=t40_coalesce_first_non_null
// CID-SHARED-122 | mode=success | case=t40_null_arithmetic_propagation
// CID-SHARED-123 | mode=success | case=t40_null_comparison
// CID-SHARED-124 | mode=success | case=t40_is_null_filter
// CID-SHARED-125 | mode=success | case=t40_is_not_null_filter
// CID-SHARED-126 | mode=success | case=t41_tointeger_from_float
// CID-SHARED-127 | mode=success | case=t41_tointeger_from_string
// CID-SHARED-128 | mode=success | case=t41_tofloat_from_int
// CID-SHARED-129 | mode=success | case=t41_tofloat_from_string
// CID-SHARED-130 | mode=success | case=t41_tostring_from_int
// CID-SHARED-131 | mode=success | case=t41_tostring_from_bool
// CID-SHARED-132 | mode=success | case=t41_toboolean_from_string
// CID-SHARED-133 | mode=success | case=t42_abs_negative
// CID-SHARED-134 | mode=success | case=t42_ceil
// CID-SHARED-135 | mode=success | case=t42_floor
// CID-SHARED-136 | mode=success | case=t42_round
// CID-SHARED-137 | mode=success | case=t42_sign
// CID-SHARED-138 | mode=success | case=t42_sqrt
// CID-SHARED-139 | mode=success | case=t42_log
// CID-SHARED-140 | mode=success | case=t42_e_constant
// CID-SHARED-141 | mode=success | case=t42_pi_constant
// CID-SHARED-142 | mode=success | case=t43_replace
// CID-SHARED-143 | mode=success | case=t43_ltrim
// CID-SHARED-144 | mode=success | case=t43_rtrim
// CID-SHARED-145 | mode=success | case=t43_split
// CID-SHARED-146 | mode=success | case=t43_reverse
// CID-SHARED-147 | mode=success | case=t43_substring
// CID-SHARED-148 | mode=success | case=t44_range_function
// CID-SHARED-149 | mode=success | case=t44_range_with_step
// CID-SHARED-150 | mode=success | case=t44_list_index_access
// CID-SHARED-151 | mode=success | case=t44_list_size
// CID-SHARED-152 | mode=success | case=t44_list_comprehension
// CID-SHARED-153 | mode=success | case=t44_reduce
// CID-SHARED-154 | mode=success | case=t45_map_literal
// CID-SHARED-155 | mode=success | case=t45_map_access
// CID-SHARED-156 | mode=success | case=t45_nested_map
// CID-SHARED-157 | mode=success | case=t45_keys_function
// CID-SHARED-158 | mode=success | case=t46_multiple_match_cartesian
// CID-SHARED-159 | mode=success | case=t46_multiple_match_correlated
// CID-SHARED-160 | mode=success | case=t46_multiple_match_independent
// CID-SHARED-161 | mode=success | case=t47_remove_property
// CID-SHARED-162 | mode=success | case=t47_remove_multiple_properties
// CID-SHARED-163 | mode=success | case=t47_remove_label
// CID-SHARED-164 | mode=success | case=t48_param_in_where
// CID-SHARED-165 | mode=success | case=t48_param_in_create
// CID-SHARED-166 | mode=success | case=t48_param_multiple
// CID-SHARED-167 | mode=success | case=t48_param_string
// CID-SHARED-168 | mode=success | case=t49_explain_basic
// CID-SHARED-169 | mode=success | case=t50_create_index_via_api
// CID-SHARED-170 | mode=success | case=t50_index_with_updates
// CID-SHARED-171 | mode=success | case=t50_index_range_query
// CID-SHARED-172 | mode=success | case=t51_concurrent_read_snapshots
// CID-SHARED-173 | mode=success | case=t51_read_txn_isolation
// CID-SHARED-174 | mode=error | case=t52_syntax_error_detail
// CID-SHARED-175 | mode=error | case=t52_unknown_function_error
// CID-SHARED-176 | mode=error | case=t52_type_error_in_arithmetic
// CID-SHARED-177 | mode=error | case=t52_division_by_zero
// CID-SHARED-178 | mode=error | case=t52_missing_property_returns_null
// CID-SHARED-179 | mode=error | case=t52_delete_connected_node_error
// CID_REGISTRY_END
