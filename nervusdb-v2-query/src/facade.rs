...
//! to any type that implements [`nervusdb_v2_api::GraphSnapshot`].
//!
//! # Example
//!
//! ```rust,ignore
//! use nervusdb_v2_query::{prepare, QueryExt};
//!
//! fn query_example(snapshot: &impl GraphSnapshot) {
//!     let rows = nervusdb_v2_query::query_collect(
//!         snapshot,
...
//!
//! This module re-exports the following types from `nervusdb_v2_api`:
...
///
/// ```rust,ignore
/// use nervusdb_v2_query::query_collect;
///
...
///
/// ```rust,ignore
/// use nervusdb_v2_query::QueryExt;
///
/// fn query_example(snapshot: &impl GraphSnapshot) {
