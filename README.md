...
and safety guarantees are implemented and covered by 237 passing tests (238 total, 1 intentionally ignored). The on-disk format is
...
tests/              20 suites, 211 cases (+25 inline unit tests, +2 doctests)
