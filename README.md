...
and safety guarantees are implemented and covered by 259 passing tests (260 total, 1 intentionally ignored). The on-disk format is
...
tests/              21 suites, 230 cases (+28 inline unit tests, +2 doctests)
