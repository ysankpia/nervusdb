...
and safety guarantees are implemented and covered by 260 passing tests (261 total, 1 intentionally ignored). The on-disk format is
...
tests/              21 suites, 231 cases (+28 inline unit tests, +2 doctests)
