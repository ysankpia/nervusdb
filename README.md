...
and safety guarantees are implemented and covered by 248 passing tests (249 total, 1 intentionally ignored). The on-disk format is
...
tests/              21 suites, 219 cases (+28 inline unit tests, +2 doctests)
