...
and safety guarantees are implemented and covered by 233 passing tests (234 total, 1 intentionally ignored). The on-disk format is
...
tests/              20 suites, 207 cases (+25 inline unit tests, +2 doctests)
