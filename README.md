...
and safety guarantees are implemented and covered by 250 passing tests (251 total, 1 intentionally ignored). The on-disk format is
...
tests/              21 suites, 221 cases (+28 inline unit tests, +2 doctests)
