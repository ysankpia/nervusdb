...
and safety guarantees are implemented and covered by 252 passing tests (253 total, 1 intentionally ignored). The on-disk format is
...
tests/              21 suites, 223 cases (+28 inline unit tests, +2 doctests)
