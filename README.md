...
and safety guarantees are implemented and covered by 244 passing tests (245 total, 1 intentionally ignored). The on-disk format is
...
tests/              20 suites, 215 cases (+28 inline unit tests, +2 doctests)
