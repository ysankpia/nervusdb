...
and safety guarantees are implemented and covered by 240 passing tests (241 total, 1 intentionally ignored). The on-disk format is
...
tests/              20 suites, 214 cases (+25 inline unit tests, +2 doctests)
