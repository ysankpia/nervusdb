...
and safety guarantees are implemented and covered by 232 passing tests (233 total, 1 intentionally ignored). The on-disk format is
...
tests/              20 suites, 206 cases (+25 inline unit tests, +2 doctests)
