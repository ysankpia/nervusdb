...
and safety guarantees are implemented and covered by 225 passing tests (226 total, 1 intentionally ignored). The on-disk format is
...
tests/              17 suites, 199 cases (+25 inline unit tests, +2 doctests)
