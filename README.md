...
and safety guarantees are implemented and covered by 224 passing tests (225 total, 1 intentionally ignored). The on-disk format is
...
tests/              17 suites, 198 cases (+25 inline unit tests, +2 doctests)
