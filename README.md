...
and safety guarantees are implemented and covered by 231 passing tests (232 total, 1 intentionally ignored). The on-disk format is
...
tests/              19 suites, 205 cases (+25 inline unit tests, +2 doctests)
