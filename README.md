...
and safety guarantees are implemented and covered by 254 passing tests (255 total, 1 intentionally ignored). The on-disk format is
...
tests/              21 suites, 225 cases (+28 inline unit tests, +2 doctests)
