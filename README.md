...
and safety guarantees are implemented and covered by 249 passing tests (250 total, 1 intentionally ignored). The on-disk format is
...
tests/              21 suites, 220 cases (+28 inline unit tests, +2 doctests)
