...
and safety guarantees are implemented and covered by 257 passing tests (258 total, 1 intentionally ignored). The on-disk format is
...
tests/              21 suites, 228 cases (+28 inline unit tests, +2 doctests)
