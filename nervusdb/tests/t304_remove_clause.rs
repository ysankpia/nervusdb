use nervusdb::query::{Params, Value, WriteableGraph};
use nervusdb::{Db, GraphSnapshot, PropertyValue};
use tempfile::tempdir;

#[test]
fn test_remove_node_property() -> nervusdb::Result<()> {
    let dir = tempdir()?;
...
#[test]
fn test_remove_edge_property() -> nervusdb::Result<()> {
    let dir = tempdir()?;
...
#[test]
fn test_remove_node_label() -> nervusdb::Result<()> {
    let dir = tempdir()?;
...
#[test]
fn test_remove_node_property_is_visible_in_same_query() -> nervusdb::Result<()> {
    let dir = tempdir()?;
...
#[test]
fn test_remove_missing_node_property_reports_zero_side_effects() -> nervusdb::Result<()> {
    let dir = tempdir()?;
...
#[test]
fn test_remove_relationship_property_is_visible_in_same_query() -> nervusdb::Result<()> {
    let dir = tempdir()?;
